...
```
    go get -v github.com/adamluo159/cellnet/protoc-gen-msg

    go install -v github.com/adamluo159/cellnet/protoc-gen-msg
```
...
```
${GOPATH}/github.com/adamluo159/cellnet/codec/gogopb/test/export.sh
```
